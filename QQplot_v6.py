...
# Parameters:
# - filename: name of input file that contains all SNPs discovered, should starts with column titles.
#             Can also provide a dataframe, then will skip reading the GWAS result        
...
def qqplot(filename,
           ...
           ldPop='EUR',
           plot_ci=True,
           ci=0.95, fig=None, ax=None, savefig=True, **kwargs):
        
    if not isinstance(filename, pd.DataFrame):
