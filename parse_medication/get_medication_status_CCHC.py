'''
Compare the medication columns in the CCHC phenotype file (such as /data100t1/share/CCHC/phenotypes/0724/cchc_phenotypes_0724.txt) with a list of drugs.
Find if each individual used any of the drug in the list (1) or not (0) at any vist
...
Example runs:
python get_medication_status_CCHC.py \
--phenotype_fn ./example_data/meds_record_CCHC.csv \
--drug_name_cols DRUG_NAME \
--med_list ./meds_list/lipid_lowering.txt \
--output_path ./output \
--output_prefix test_run

# Real data
# python /data100t1/home/wanying/BioVU/202405_PAGE_PRS/code/utils/get_medication_status_CCHC.py \
# --phenotype_fn /data100t1/share/CCHC/phenotypes/0724/cchc_phenotypes_0724.txt \
# --drug_name_cols DRUG_NAME \
...
def process_args(log_args=True):
    ...
    parser.add_argument('--phenotype_fn', help='File name of the phenotype file. Assume delimiter is |', type=str,
                        default='/data100t1/share/CCHC/phenotypes/0724/cchc_phenotypes_0724.txt')
    parser.add_argument('--drug_name_cols', nargs='*', type=str, help='Columns contain medication info to compare with the list of drug names',
                        default='DRUG_NAME')
